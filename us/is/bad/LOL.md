Tu as raison. 
Pour un site de guérilla, zéro dépendance externe = autonomie totale. 
Je refais avec du CSS pur intégré — plus léger, plus rapide, indépendant.

> **Version corrigée : `systeme-bloque-standalone.html`**
