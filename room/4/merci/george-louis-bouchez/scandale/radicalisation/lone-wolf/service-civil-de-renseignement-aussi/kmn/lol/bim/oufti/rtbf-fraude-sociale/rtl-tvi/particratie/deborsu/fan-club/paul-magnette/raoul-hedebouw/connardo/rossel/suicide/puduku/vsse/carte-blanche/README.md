> **⚠️ ATTENTION — ÉTAT DES URL**
>
> Ce guide de déploiement contient des URL qui **n'existent pas encore**. C'est normal : ce sont des cibles de déploiement. Voici l'état actuel :
>
> | URL | Statut |
> |-----|--------|
> | `ouaisfi.eu` | ✅ Existe |
> | `ouaisfieu.github.io/tech/` | ✅ Existe |
> | `ouaisfieu.github.io/bxl2030/` | ✅ Existe |
> | `ouaisfieu.github.io/dossiers/` | ✅ Existe |
> | `dl.ouaisfi.eu/earl/` | ✅ Existe |
> | `dl.ouaisfi.eu/1160/` | ✅ Existe |
> | `dl.ouaisfi.eu/biologia/` | ✅ Existe |
> | `github.com/ouaisfieu` | ✅ Existe |
> | `ouaisfi.eu/service-civil-de-renseignement` | 🔧 **À CRÉER** (Phase 1 — la page pilier `index.html`) |
> | `ouaisfi.eu/knowledge-graph.jsonld` | 🔧 **À DÉPLOYER** (Phase 1) |
> | `ouaisfi.eu/llms.txt` | 🔧 **À DÉPLOYER** (Phase 1) |
> | `ouaisfi.eu/robots.txt` | 🔧 **À DÉPLOYER** (Phase 1) |
> | `ouaisfi.eu/sitemap.xml` | 🔧 **À VÉRIFIER/CRÉER** |
> | `ouaisfi.eu/intelligence-citoyenne` | ❌ **N'existe pas** — Phase 3 (semaines 2-4) |
> | `ouaisfi.eu/osint-citoyen` | ❌ **N'existe pas** — Phase 3 |
> | `ouaisfi.eu/sousveillance` | ❌ **N'existe pas** — Phase 3 |
> | `ouaisfi.eu/glossaire` | ❌ **N'existe pas** — Phase 3 |
> | Autres satellites | ❌ **N'existent pas** — Phase 3 |
>
> **Ne déployez les liens internes vers les satellites qu'APRÈS avoir créé les pages correspondantes.**
